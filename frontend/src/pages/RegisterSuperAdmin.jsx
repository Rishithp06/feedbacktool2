...
import { registerSuperAdmin } from '../services/api'; // Import the API function
...
const RegisterSuperAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(err.response?.data?.message || 'User exists already');
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      ...
      <div className="register-page">
        <div className="register-container">
          <h1 className="register-title">Register as a Super Admin</h1>
